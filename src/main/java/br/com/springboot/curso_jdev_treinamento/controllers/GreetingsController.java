 ...
 */
@RestController /*Essa anotação diz que essa classe vai capitar toda as requisições, primeiro passa pelo Controller para depois executar o metodo*/
public class GreetingsController {
	
	@Autowired /* IC/CD ou CDI - Injeção de Dependência*/
	private UsuarioRepository usuarioRepository;

    @RequestMapping(value = "/mostrarnome/{name}", method = RequestMethod.GET) /*Essa anotação é para especificar a URL que será usada e o tipo do metodo (GET, POST, PUT, DELETE)*/
